...
export const Error: Story = {
  render: () => (
    <Card className="w-[350px] border-error/50 shadow-error/50">
      ...
      <CardContent>
        <div className="font-mono text-sm space-y-2 text-error/90">
    ...
    <Card className="w-[350px]">
      ...
      <CardContent className="space-y-4">
        <div className="space-y-2">
          <label className="text-sm font-mono">Memory Limit</label>
          <input
            type="text"
            className="w-full px-3 py-1 font-mono text-sm bg-transparent border-2 border-dashed"
            defaultValue="8192MB"
          />
        </div>
        <div className="space-y-2">
          <label className="text-sm font-mono">Process Count</label>
          <input
            type="text"
            className="w-full px-3 py-1 font-mono text-sm bg-transparent border-2 border-dashed"
            defaultValue="4"
