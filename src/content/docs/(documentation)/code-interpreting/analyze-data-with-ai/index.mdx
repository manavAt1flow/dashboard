---
title: Overview
description: This guide will show you how to analyze data with AI using E2B Sandbox.
---
...
![Chart visualizing voting average of our dataset over time](/graphics/docs/analyze-data-chart.png)
